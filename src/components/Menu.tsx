...
import { calendarOutline, hammer, moonOutline, help, informationCircleOutline, logIn, logOut, mapOutline, peopleOutline, person, personAdd, listOutline } from 'ionicons/icons';
...
const routes = {
  appPages: [
    { title: 'KOLs', path: '/tabs/kols', icon: listOutline }
  ],
  loggedInPages: [
...
export default connect<{}, StateProps, {}>({
  mapStateToProps: (state) => ({
    ...
    menuEnabled: false //state.data.menuEnabled
  }),
  mapDispatchToProps: ({
    setDarkMode
  }),
